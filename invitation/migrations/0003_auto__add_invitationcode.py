...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invitation_invitationcode', (
            ...
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invitation_code_set', to=orm['auth.User'])),
            ('redeem_limit', self.gf('django.db.models.fields.IntegerField')()),
        ))
