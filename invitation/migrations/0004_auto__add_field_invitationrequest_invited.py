...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvitationRequest.invited'
        db.add_column('invitation_invitationrequest', 'invited',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvitationRequest.invited'
        db.delete_column('invitation_invitationrequest', 'invited')
    ...
    models = {
        ...
        'invitation.invitationcode': {
            ...
            'from_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invitation_code_set'", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'redeem_limit': ('django.db.models.fields.IntegerField', [], {})
        },
